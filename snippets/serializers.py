...
class UserSnippetSerializer(serializers.HyperlinkedModelSerializer):
    ## PrimaryKeyRelatedField --> mean that he will make query to get all things owned by this model (User) by his primay key
    snippets = serializers.HyperlinkedRelatedField(many=True, queryset=Snippet.objects.all(), view_name="snippets-list")
    class Meta:
        model = User
